...
urlpatterns = [
    ...
    path('project/<int:pk>/audio/upload/', views.project_audio_upload, name='project_audio_upload'),
    path('project/<int:pk>/audio/', views.project_audio_detail, name='project_audio_detail'),
