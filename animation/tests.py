...
class ProjectAccessTests(TestCase):
    ...
    def test_project_list_includes_shared_projects_for_viewer(self):
        ...
        self.assertContains(response, 'id="browse-projects-modal"')
        self.assertContains(response, 'id="browse-projects-search"')
        self.assertContains(response, 'data-browse-create')
